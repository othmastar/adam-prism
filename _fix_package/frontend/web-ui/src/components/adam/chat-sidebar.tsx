...
const navSections: NavSection[] = [
  ...
  { titleAr: "المعرفة", titleEn: "Knowledge", icon: Database, items: [
    ...
    { view: "ltm", icon: Layers, labelAr: "LTM (Vector)", labelEn: "LTM (Vector)", descAr: "بحث هجين في الذاكرة طويلة المدى", descEn: "Hybrid vector memory search" },
  ...
  { titleAr: "الأدوات", titleEn: "Tools", icon: Wrench, items: [
    ...
    { view: "browser", icon: Globe, labelAr: "المتصفح", labelEn: "Browser", descAr: "متصفح Playwright متعدد التبويبات", descEn: "Playwright multi-tab browser" },
    { view: "mcp", icon: Server, labelAr: "MCP", labelEn: "MCP", descAr: "إدارة MCP servers", descEn: "MCP server management" },
            ...
            <div className="space-y-1 pb-4">
              {searchQuery.trim() ? (
                searchResults.length === 0 ? (
                  <Fragment key="no-search-results">
