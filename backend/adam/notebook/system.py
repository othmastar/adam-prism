...
class AdamNotebook:
    ...
    async def add_summary(self, title: str, summary: str, source: str, key_topics: list[str] | None = None):
        """إضافة ملخص"""
        ...
        with open(summary_file, "w", encoding="utf-8") as f:
            ...
            f.write(f"## الملخص\n{summary}\n\n")
            if key_topics:
                f.write("## المواضيع الرئيسية\n")
                for topic in key_topics:
                    f.write(f"- {topic}\n")

        self.daily_stats["summaries_written"] += 1

    async def get_daily_note(self, date: str | None = None) -> str:
