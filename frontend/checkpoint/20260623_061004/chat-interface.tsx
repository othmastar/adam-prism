      ...
      <div className="border-t border-border p-3 sm:p-4 glass-subtle shrink-0 chat-input-area" style={{ paddingBottom: "calc(env(safe-area-inset-bottom, 0px) + 0.75rem)" }}>
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex items-end gap-2">
            <ShieldPulse />
            {/* Voice input — معطل مؤقتاً لحين تشغيل STT/TTS */}
            <div className="relative shrink-0 group">
              <VoiceButton onAudioReady={handleAudioReady} disabled={true} />
              <div className="absolute -top-1 -right-1 h-4 w-4 bg-destructive rounded-full flex items-center justify-center shadow-sm z-20">
                <svg className="h-2.5 w-2.5 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>
              </div>
              <span className="absolute -bottom-5 left-1/2 -translate-x-1/2 text-[8px] text-muted-foreground whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity">
